...
\begin{itemize}
    ...
    \item \textbf{Strict Exogeneity:} While strict exogeneity is not testable, the BG test and correlation analysis of $X$ support the weak exogeneity assumption. Therefore, we elect to proceed with the assumption of exogeneity given the results of all prior diagnostics.
