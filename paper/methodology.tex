...
\begin{itemize}
    ...
    A confirmation of homoscedasticity via the \textbf{Breusch\textbf{\rule[0.5ex]{0.5em}{0.7pt}Pagan Test}} and absence of first order autocorrelation via the \textbf{Durbin\textbf{\rule[0.5ex]{0.5em}{0.7pt}Watson Test}} will be performed to validate this condition.
\end{itemize}