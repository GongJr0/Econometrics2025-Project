...
\begin{itemize}
    ...
    Given the application of RESET is inappropriate for level based time-series data, as a final check, we will apply the \textbf{Harvey\rule[0.5ex]{0.5em}{0.7pt}Collier Test} for to assess model specification.
