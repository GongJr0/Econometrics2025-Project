...
\vspace{\baselineskip}
By Okun's Law, we expect the unemployment gap to be modelled by the output gap and a negative coefficient.
Therefore, the interaction $O_t$ should be a redundant variable in the presence of its components (main-effects).
...
Yet, in a growth rate context, we believe there's benefit in testing how the Okun based dynamics are mapped outside the gap framework.
